/** @file
  ...
  AMD Internal PCIe Complex Data Structures.
...
typedef enum {
  ...
  DxioUBMHFCEngine   = 5,                                 ///< UBM HFC Connector for auto-discovery
  DxioOCP3Engine     = 6,                                 ///< OCP3 Bifurcatable Connector
  DxioUdot3Engine    = 7,                                 ///< U.3 Multiprotocol Connector
