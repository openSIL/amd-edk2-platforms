...
!if $(OPENSILSUPPORT) == TRUE
  AgesaRedirects/Addendum/PciSegments/PciExpressPciCfg2/PciExpressPciCfg2.inf {
    <LibraryClasses>
      DebugLib|MdePkg/Library/BaseDebugLibNull/BaseDebugLibNull.inf
  }
!else
...
AgesaPkg/Addendum/Oem/OobPprDxe/OobPprDxe.inf
  ...
  # PRM Libraries
  #
  edk2/PrmPkg/Library/DxePrmContextBufferLib/DxePrmContextBufferLib.inf

  #
  # PRM Module Discovery Library
  #
  edk2/PrmPkg/Library/DxePrmModuleDiscoveryLib/DxePrmModuleDiscoveryLib.inf

  #
  # PRM PE/COFF Library
  #
  edk2/PrmPkg/Library/DxePrmPeCoffLib/DxePrmPeCoffLib.inf

  #
  # PRM Module Loader Driver
  #
  edk2/PrmPkg/PrmLoaderDxe/PrmLoaderDxe.inf

[LibraryClasses.common.DXE_DRIVER, LibraryClasses.common.DXE_RUNTIME_DRIVER, LibraryClasses.common.UEFI_APPLICATION]
  #
  # PRM Package
  #
  PrmContextBufferLib|edk2/PrmPkg/Library/DxePrmContextBufferLib/DxePrmContextBufferLib.inf
  PrmModuleDiscoveryLib|edk2/PrmPkg/Library/DxePrmModuleDiscoveryLib/DxePrmModuleDiscoveryLib.inf
  PrmPeCoffLib|edk2/PrmPkg/Library/DxePrmPeCoffLib/DxePrmPeCoffLib.inf
